...
class ColoredFormatter(logging.Formatter):
    ...
    `TENT_PITCHING_COLORS_DISABLE` environment variable to `1`.
    """

    def __init__(self):
        disable_colors = int(os.environ.get('TENT_PITCHING_COLORS_DISABLE', 0)) == 1
        if disable_colors:
...
def getLogger(module, level=None, filename=''):
    """Get the logger of the respective module for the logging facility.
    Parameters
    ----------
    module
        Name of the module.
    ...
    filename
        ...
        written to.
    """
    module = 'tent_pitching' if module == '__main__' else module
...
def set_log_levels(levels=None):
    """Set log levels for the logging facility.
    Parameters
    ----------
    levels
    ...
    """
    levels = levels or {'tent_pitching': 'INFO'}
